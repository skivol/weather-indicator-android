...
class WeatherMeasurementsAppWidgetProvider : AppWidgetProvider() {
    ...
    override fun onAppWidgetOptionsChanged(context: Context?, appWidgetManager: AppWidgetManager?, appWidgetId: Int, newOptions: Bundle?) {
        ...
        if (context != null && appWidgetManager != null && newOptions != null) {
            ...
            val cellsCount = (minWidth + 30) / 70 // https://developer.android.com/guide/practices/ui_guidelines/widget_design.html#anatomy_determining_size

            val textSize = when(cellsCount) {
                3 -> 26
                in 4..Int.MAX_VALUE -> 40
                else -> 18 // default text size for 2 cell width
            }.toFloat()
            ...
            remoteViews.setTextViewTextSize(R.id.error_message_text, COMPLEX_UNIT_SP, textSize)
